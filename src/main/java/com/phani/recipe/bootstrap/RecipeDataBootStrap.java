package com.phani.recipe.bootstrap;


import com.phani.recipe.models.*;
import com.phani.recipe.repositories.CategoryRepository;
...
public class RecipeDataBootStrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeDataBootStrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
